...
import com.tutorial.querydsl.repository.CategoryRepository;
...
public class ItemServiceImpl implements ItemService{
    ...
    public ItemDto createItem(ItemDto itemDto) {
        ...
        Category category = categoryRepository.findByName(itemDto.getCategoryDto().getName());
        if(category == null) {
            category = new Category();
            category.setName(itemDto.getCategoryDto().getName());
